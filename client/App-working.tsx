...
import { SafeAuthProvider } from "@/contexts/AuthContextSafe"; // Using safe version
...
const Dealers = lazy(() => import("@/pages/RegisteredDealers"));
      ...
      <main className="flex-1">
        <Suspense fallback={
          ...
          <Routes>
            ...
            <Route path="/insurance" element={<PlaceholderPage title="Car Insurance" />} />
...
function App() {
  console.log("🟢 App loading with SafeAuthProvider...");
