...
export const mkTranslations: TranslationStrings = {
  ...
  modals: {
    ...
    financing: {
      ...
      placeholders: {
        ...
        enterPhone: 'Внесете го вашиот телефон',
        enterEmail: 'Внесете ја вашата е-пошта',
        enterLoanAmount: 'Внесете го износот на кредитот',
        enterAnnualIncome: 'Внесете ја годишната заработка',
        enterMonthlyExpenses: 'Внесете ги месечните трошоци',
    ...
    scheduleTestDrive: {
      ...
      placeholders: {
        ...
        enterEmail: 'Внесете ја вашата е-пошта',
        enterPhone: 'Внесете го вашиот телефон',
        selectDate: 'Изберете преферирана дата',
        selectTime: 'Изберете преферирано време',
        enterRequests: 'Некои специјални барања или прашања?'
      },
      validation: {
        emailInvalid: 'Ве молиме внесете валидна е-пошта',
        dateRequired: 'Ве молиме изберете преферирана дата',
        timeRequired: 'Ве молиме изберете преферирано време'
      },
      success: {
    ...
    tradeIn: {
      ...
      form: {
        labels: {
          ...
          serviceHistory: 'Историја на сервисирање',
        ...
        placeholders: {
          ...
          selectModel: 'Изберете модел',
          selectYear: 'Изберете година',
          enterMileage: 'Внесете пробег во километри',
          selectCondition: 'Изберете општа состојба',
          selectAccidentHistory: 'Изберете историја на несреќи',
          selectServiceHistory: 'Изберете историја на сервисирање',
      ...
      validation: {
        ...
        mileageRequired: 'Ве молиме внесете пробег',
        mileageInvalid: 'Ве молиме внесете валиден пробег',
        conditionRequired: 'Ве молиме изберете општа состојба',
        accidentRequired: 'Ве молиме изберете историја на несреќи',
        serviceRequired: 'Ве молиме изберете историја на сервисирање',
      ...
      actions: {
        calculate: 'Пресметај процена',
        recalculate: 'Препресметај',
  ...
  advancedSearch: {
    ...
    // Additional missing translations for advanced search
    description: 'Користи ги нашите сеопфатни филтри за пребарување да го откриеш точното возило што го бараш',
    searchControls: 'Контроли за пребарување',
    refineSearchCriteria: 'Прецизирај ги критериумите за пребарување',
    clearAllFilters: 'Исчисти ги сите филтри',
    activeFilters: 'Активни филтри',
    realTimeSearch: 'Пребарување во реално време',
    searchingRealTime: 'Се пребарува во реално време...',
    
    // Static vehicle data sections
    staticVehicleData: {
      makes: [
      ...
      bodyTypes: [
        'Седан', 'SUV', 'Хечбек', 'Купе', 'Кабриолет', 'Караван', 'Пикап', 'Ван',
        'Мини ван', 'Кросовер', 'Компакт', 'Субкомпакт', 'Средна големина', 'Голема големина',
        'Спортски автомобил', 'Луксузен', 'Економичен', 'Хибрид'
      ],
      fuelTypes: [
        'Бензин', 'Дизел', 'Хибрид', 'Електричен', 'Плаг-ин хибрид', 'Природен гас', 'Пропан',
        'Флекс гориво', 'Водород', 'Биодизел', 'E85 Етанол'
      ],
      transmissions: [
        'Мануелна', 'Автоматска', 'CVT', 'Полуавтоматска', 'Двојна спојка', '6-степена мануелна',
        '7-степена автоматска', '8-степена автоматска', '9-степена автоматска', '10-степена автоматска'
      ],
      drivetrains: [
        'Предни тркала', 'Задни тркала', 'Сите тркала', '4WD', 
        'Дел-време 4WD', 'Цело-време 4WD', 'Електронски сите тркала', 'Мануелен сите тркала'
      ],
      sellerTypes: [
        'Дилер', 'Приватен продавач', 'Сертифициран дилер', 'Овластен дилер', 'Увозник'
      ],
      colors: [
        'Црна', 'Бела', 'Сребрена', 'Сива', 'Сина', 'Тамноцрвена', 'Црвена', 'Зелена', 'Бургунди', 
        'Кафена', 'Златна', 'Жолта', 'Портокалова', 'Виолетова', 'Тан', 'Бронзена', 'Бакарна',
        'Бисерна бела', 'Металик сребрена', 'Темносина', 'Натпреварувачка црвена', 'Шумска зелена',
        'Јаглерод', 'Поморска', 'Беж'
      ],
      interiorColors: [
        'Црна', 'Сива', 'Беж', 'Кафена', 'Црвена', 'Сина', 'Бела', 'Кремова', 'Друга'
      ],
      paintworkTypes: [
        'Металик', 'Перла', 'Мат', 'Гланцирана', 'Друга'
      ],
      upholsteryTypes: [
        'Ткаенина', 'Полна кожа', 'Делумна кожа', 'Алкантара', 'Вештачка кожа', 'Друга'
      ],
      conditions: [
        'Нов', 'Како нов', 'Одличен', 'Многу добар', 'Добар', 'Задоволителен', 'Користен', 
        'Сертифициран употребуван', 'Реставриран', 'Обновен', 'Отпаден', 'Винтиџ'
      ],
      countries: [
        'Македонија', 'Германија', 'Австрија', 'Италија', 'Белгија', 'Холандија', 'Шпанија', 
        'Луксембург', 'Франција', 'Швајцарија', 'Полска', 'Чешка', 'Словачка', 'Словенија', 
        'Хрватска', 'Србија', 'Бугарија', 'Романија', 'Унгарија', 'Грција'
      ],
      emissionClasses: [
        'Euro 6', 'Euro 5', 'Euro 4', 'Euro 3', 'Euro 2', 'Euro 1', 'Без сертификат'
      ],
      emissionLabels: [
        'Зелена (4)', 'Жолта (3)', 'Портокалова (2)', 'Црвена (1)', 'Без знак'
      ],
      guaranteeOptions: [
        'Фабричка гаранција', 'Дилерска гаранција', 'Проширена гаранција', 'Без гаранција'
      ],
      features: [
        'Климатизер', 'Кожни седишта', 'Навигациски систем', 'Bluetooth', 'USB портови',
        'Камера за паркирање', 'Сензори за паркирање', 'Грејани седишта', 'Покрив прозорец', 'Алуминиуми бандажи',
        'Темпомат', 'ABS', 'Контрола на стабилност', 'Воздушни перничиња',
        'Далечинско палење', 'Безклучно влегување', 'Електрични прозорци', 'Серво управување', 'Тонирани стакла',
        ...
        'Следење слепа точка', 'Предупредување за судир', 'Автоматско итно запирање',
        'Адаптивен темпомат', 'Помош за паркирање', 'Камера за заден ход', '360-степена камера',
        'Греен воланот', 'Ладени седишта', 'Вентилирани седишта', 'Мемориски седишта',
        'Електрично подесување седишта', 'Трет ред седишта', 'Склопливи задни седишта', 
        'Покривач за товарен простор', 'Кров носач', 'Пакет за влечење', 'Бочни степеници', 'Странични степеници'
      ],
      certifications: [
        'Сертифициран употребуван', 'Фабричка гаранција', 'Проширена гаранција', 
        'Помош на патот', 'Извештај за историја на возилото', 'Мулти-поен инспекција',
        'Тест за емисии', 'Безбедносна инспекција', 'Дилерски сертифициран', 'Трето лице сертифициран',
        'Carfax верификуван', 'AutoCheck верификуван', 'Без несреќи', 'Еден сопственик',
        'Достапни сервисни записи', 'Одржувањето е ажурирано'
      ]
    },
  },
  ...
  sell: {
    ...
    vehicleTypes: {
      car: {
        name: 'Автомобил',
        description: 'Седани, кросовери, купеа, хечбек'
      },
      truck: {
        name: 'Камион',
      ...
      motorbike: {
        name: 'Мотоцикл',
        description: 'Мотоцикли, скутери, квадроцикли'
      }
    },
    ...
    fields: {
      ...
      featuresAndOptions: 'Спецификации и опции',
      description: 'Опис',
      vehiclePhotos: 'Фотографии од возилото',
    ...
    placeholders: {
      ...
      priceExample: '25.000',
      descriptionExample: 'Опишете ја состојбата на вашето возило, историјата и дополнителни детали...',
      yourFullName: 'Вашето целосно име',
      phoneExample: '070 123-456',
      emailExample: 'vasha.poshta@primer.com',
      cityState: 'Град, Регион',
      yourName: 'Вашето име',
      ...
      describeYourVehicle: 'Опишете го вашиот автомобил...',
    ...
    features: {
      ...
      keylessEntry: 'Безклучен пристап',
      remoteStart: 'Далечинско стартување',
      cruiseControl: 'Круз контрола',
      parkingSensors: 'Сензори за паркирање',
      blindSpotMonitoring: 'Контрола на слепи агли'
    }
  },
  ...
  success: {
    ...
    loggedIn: 'Успешно најавување!',
    loggedOut: 'Успешно одјавување!',
    passwordReset: 'Писмото за ресетирање лозинка е испратено!',
    subscribed: 'Успешно претплатени!',
  ...
  browseCars: {
    ...
    filters: {
      ...
      to: 'до',
      yearRange: 'Опсег на години',
      mileageRange: 'Максимален пробег',
      location: 'Локација',
      ...
      noMin: 'Без мин.',
      noMax: 'Без макс.',
      anyLocation: 'Внесете град или поштенски код',
      kilometers: 'км',
      miles: 'милји',
      any: 'Било која'
    },
    results: {
      ...
      of: 'од',
      results: 'автомобили најдени',
      noResults: 'Нема најдени автомобили',
      noResultsMessage: 'Обидете се да ги смените условите за пребарување',
  ...
  advancedSearch: {
    ...
    sections: {
      ...
      technicalSpecs: {
        title: 'Технички спецификации',
        description: 'Мотор, менувач и детали за перформанси'
      },
      featuresEquipment: {
        title: 'Карактеристики и опрема',
        description: 'Внатрешни и надворешни карактеристики'
      },
      preferencesAndCertifications: {
        title: 'Преференци и сертификации',
        description: 'Тип на продавач и сертификати'
      },
      vehicleDetails: {
        title: 'Детали за возилото',
        description: 'Состојба, историја и проверки'
      },
      priceLocation: {
        title: 'Цена и локација',
        description: 'Буџет и географски преференци'
      },
      featuresOptions: {
        title: 'Карактеристики и опции',
    ...
    staticVehicleData: {
      makes: ['Toyota', 'Honda', 'BMW', 'Mercedes-Benz', 'Audi', 'Volkswagen', 'Ford', 'Nissan', 'Hyundai', 'Kia', 'Mazda', 'Subaru', 'Mitsubishi', 'Lexus', 'Porsche', 'Ferrari', 'Lamborghini', 'Maserati', 'Jaguar', 'Land Rover', 'Volvo', 'Peugeot', 'Renault', 'Citroën', 'Fiat', 'Alfa Romeo', 'Škoda', 'SEAT', 'Opel', 'Chevrolet', 'Cadillac', 'Buick', 'Lincoln', 'Acura', 'Infiniti', 'Genesis'],
      
      bodyTypes: ['Седан', 'Хечбек', 'Караван', 'SUV', 'Купе', 'Кабриолет', 'Пикап', 'Ван', 'Минибус', 'Лимузина', 'Комби'],
      
      fuelTypes: ['Бензин', 'Дизел', 'Електричен', 'Хибрид', 'Приклучен хибрид', 'Водород', 'CNG', 'LPG', 'Етанол', 'Биодизел'],
      
      transmissions: ['Рачен', 'Автоматски', 'Полуавтоматски', 'CVT', '6-степен рачен', '7-степен автоматски', '8-степен автоматски', '9-степен автоматски', 'Двосепречен'],
      
      additionalProperties: ['Сертифициран стар автомобил', 'Еден сопственик', 'Без несреќи', 'Сервисни записи достапни', 'Под гаранција', 'Неодамна сервисиран', 'Мал километража', 'Чуван во гаража', 'Зимски пакет', 'Спортски пакет'],
      
      drivetrains: ['Предно тркало', 'Задно тркало', 'Сите тркала', '4x4', 'AWD', 'RWD', 'FWD'],
      
      sellerTypes: ['Дилер', 'Приватен продавач', 'Сертифициран дилер', 'Овластен дилер', 'Увозник'],
      
      conditions: ['Нов', 'Користен', 'Службен автомобил', 'Антиквитет/Класик', 'Демонстрационен', 'Предрегистриран', 'Оштетен', 'За резервни делови'],
      
      colors: ['Црна', 'Бела', 'Сребрена', 'Сива', 'Црвена', 'Сина', 'Зелена', 'Жолта', 'Оранжева', 'Виолетова', 'Кафена', 'Златна', 'Розова', 'Бургундија', 'Темно сина', 'Темно зелена', 'Бежова', 'Шампањска', 'Друга'],
      
      interiorColors: ['Црна', 'Сива', 'Бежова', 'Кафена', 'Црвена', 'Сина', 'Бела', 'Кремова', 'Друга'],
      
      paintworkTypes: ['Металик', 'Перла', 'Мат', 'Глосс', 'Друга'],
      
      upholsteryTypes: ['Ткаенина', 'Полна кожа', 'Делумна кожа', 'Алкантара', 'Вештачка кожа', 'Друга'],
      
      countries: ['Македонија', 'Германија', 'Австрија', 'Италија', 'Белгија', 'Холандија', 'Шпанија', 'Луксембург', 'Франција', 'Швајцарија', 'Полска', 'Чешка', 'Словачка', 'Словенија', 'Хрватска', 'Србија', 'Бугарија', 'Романија', 'Унгарија'],
      
      emissionClasses: ['Euro 6', 'Euro 5', 'Euro 4', 'Euro 3', 'Euro 2', 'Euro 1', 'Без сертификат'],
      
      emissionLabels: ['Зелена (4)', 'Жолта (3)', 'Оранжева (2)', 'Црвена (1)', 'Без знак'],
      
      guaranteeOptions: ['Фабричка гаранција', 'Дилерска гаранција', 'Проширена гаранција', 'Без гаранција'],
      
      previousOwnersOptions: ['1', '2', '3', '4', '5+'],
      
      turboOptions: ['Природно аспириран', 'Турбо', 'Суперчаржер', 'Твин турбо', 'Би-турбо'],
      
      enginePositions: ['Преден', 'Среден', 'Заден'],
      
      serviceBookOptions: ['Да', 'Не', 'Дигитален', 'Делумен'],
      
      yesNoUnknownOptions: ['Да', 'Не', 'Непознато'],
      
      roadworthinessOptions: ['Валиден', 'Истечен', 'Нов', 'Не е потребен'],
      
      environmentalBadges: ['Зелена ознака', 'Жолта ознака', 'Црвена ознака', 'Сина ознака', 'Без ознака'],
      
      electricRangeOptions: ['0-50 км', '51-100 км', '101-200 км', '201-300 км', '300+ км', 'Не се однесува'],
      
      features: [
        'ABS', 'Клима уред', 'Автоматска клима', 'Навигација', 'Кожни седишта', 'Греачи за седишта',
        'Електрични прозорци', 'Централно заклучување', 'Аларм', 'Airbag', 'ESP', 'Круиз контрола',
        'Паркинг сензори', 'Камера за паркирање', 'Bluetooth', 'USB', 'CD плеер', 'MP3',
        'Радио', 'Сателитско радио', 'Премиум звучен систем', 'Кров прозорец', 'Панорамски кров',
        'Спортски пакет', 'Аеропакет', 'Легури од лесни метали', 'Зимски гуми', 'Летни гуми',
        'Резервен тркало', 'Ксенон светла', 'LED светла', 'Магленки', 'Дневни светла',
        'Електрични огледала', 'Греачи за огледала', 'Тонирани стакла', 'Метална боја',
        'Start/Stop систем', 'Регенеративни кочници', 'Адаптивна крстарска контрола',
        'Систем за избегнување судир', 'Монитор за слепа точка', 'Препознавање сообраќајни знаци'
      ]
    }
  },
  ...
  contact: {
    hero: {
      ...
      subtitle: 'Овде сме за да ви помогнеме со сè што ви треба за вашето искуство со автомобили'
    },
    departments: {
    ...
    form: {
      ...
      inquiryType: {
        ...
        options: {
          ...
          buyingHelp: 'Помош за купување',
          sellingSupport: 'Поддршка за продажба',
          technicalIssue: 'Технички проблем',
          dealerInquiry: 'Дилерско барање',
          feedback: 'Повратни информации'
        }
      },
      fields: {
      ...
      placeholders: {
        ...
        phone: 'Внесете го вашиот телефон',
        subject: 'Внесете го предметот',
        message: 'Опишете го вашето прашање или повратна информација...'
      }
    },
    success: {
      title: 'Пораката е испратена!',
      message: 'Ви благодариме што не контактиравте. Ќе ви одговориме наскоро.'
    },
    quickHelp: {
      title: 'Брза помош',
      options: {
        buyingGuide: {
          ...
          description: 'Научете како да купувате автомобил на CarMarket365'
        },
        sellingGuide: {
          title: 'Водич за продажба',
          description: 'Совети за продажба на вашиот автомобил'
        },
        faq: {
          title: 'Често поставувани прашања',
          description: 'Одговори на честите прашања'
        },
        safetyTips: {
  ...
  financing: {
    title: 'Финансирање',
    description: 'Најди ја најдобрата опција за финансирање',
    badges: {
      financingAvailable: 'Финансирање достапно',
      preApproved: 'Претходно одобрено'
    },
    employmentStatus: {
      retired: 'Пензионер',
      student: 'Студент',
    ...
    validation: {
      ...
      annualIncomeRequired: 'Годишната заработка е задолжителна',
      employmentStatusRequired: 'Статусот на вработеност е задолжителен',
      loanTermRequired: 'Времетраењето на кредитот е задолжително'
    },
    success: {
      title: 'Успешно поднесена апликација!',
      description: 'Ќе ве контактираме наскоро.'
    },
    actions: {
      submit: 'Поднеси апликација',
      calculate: 'Пресметај'
    }
  },
  ...
  scheduleTestDrive: {
    badge: 'Тест возење достапно',
    title: 'Закажи тест возење',
    description: 'Закажи тест возење за ова возило',
    labels: {
      fullName: 'Целосно име',
      preferredDate: 'Преферирана дата',
      preferredTime: 'Преферирано време'
  ...
  adminDashboard: {
    tabs: {
      ...
      userManagement: 'Управување корисници',
      reports: 'Извештаи'
    }
  },
  ...
  carDetail: {
    ...
    actions: {
      ...
      testDrive: 'Закажи тест возење',
      financing: 'Побарај финансирање',
  ...
  indexPage: {
    ...
    stats: {
      title: 'Веријте на бројките',
      availableCars: 'Достапни автомобили',
      verifiedDealers: 'Верификувани дилери',
      happyCustomers: 'Задоволни клиенти',
      citiesCovered: 'Покриени градови'
    }
  },
  ...
  errors: {
    notFound: {
      ...
      message: 'Страницата што ја барате не постои.',
