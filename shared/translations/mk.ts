...
export const mkTranslations: TranslationStrings = {
  ...
  advancedSearch: {
    ...
    staticVehicleData: {
      ...
      fuelTypes: ['Бензин', 'Дизел', 'Електричен', 'Хибрид', 'Приклучлив хибрид'],
      transmissions: ['Рачен', 'Автоматски', 'CVT'],
      bodyTypes: ['Седан', 'SUV', 'Хечбек', 'Караван', 'Купе', 'Кабриолет', 'Пикап'],
      conditions: ['Нов', 'Одличен', 'Добар', 'Задоволителен'],
      colors: ['Црна', 'Бела', 'Сребрена', 'Сива', 'Црвена', 'Сина', 'Зелена']
    }
  },
