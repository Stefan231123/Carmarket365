...
export const mkTranslations: TranslationStrings = {
  ...
  pages: {
    ...
    cookiePolicy: {
      ...
      policyText: 'Оваа политика за колачиња објаснува што се колачиња и како ги користиме на нашата платформа CarMarket365. Колачињата се мали датотеки што се зачувуваат на вашиот уред за да се подобри функционалноста на веб-сајтот.',
      essential: {
        title: 'Неопходни колачиња',
        items: [
          'Сесија за најава на корисникот',
          'Безбедносни токени',
          'Преференци за јазик',
          'Привремени податоци за формата'
        ]
      },
      functional: {
        title: 'Функционални колачиња',
        items: [
          'Зачувани критериуми за пребарување',
          'Преференци за прикажување',
          'Омилени листи',
          'Локализација и временска зона'
        ]
      },
      analytics: {
        title: 'Аналитички колачиња',
        items: [
          'Статистики за посетеност',
          'Анализа на корисничкото однесување',
          'Извештаи за перформанси',
          'Податоци за подобрување на услугата'
        ]
      },
      marketing: {
        ...
        items: [
          ...
          'Следење конверзии',
          'Ретаргетирање кампањи',
          'Анализа на маркетинг ефективност'
        ]
      },
      managingPreferences: 'Управување со преференци за колачиња',
      managingPreferencesDescription: 'Имате контрола над колачињата што ги користиме. Еве како можете да ги управувате.',
      browserSettings: 'Поставки на прелистувач',
      browserSettingsItems: [
        'Блокирање сите колачиња',
        'Дозволување само неопходни',
        'Барање дозвола за секое колаче',
        'Автоматско бришење при затворање'
      ],
      platformControls: 'Контроли на платформата',
      platformControlsItems: [
        'Центар за приватност',
        'Поставки за аналитика',
        'Контрола на маркетинг',
        'Извоз на вашите податоци'
      ],
    ...
    accessibility: {
      title: 'Пристапност',
      subtitle: 'Нашата посветеност на правењето на платформата достапна за сите корисници.',
      backToHome: 'Назад на почетна',
      commitmentTitle: 'Нашата посветеност на пристапноста',
      commitmentDescription: 'Веруваме дека сите треба да имаат еднаков пристап до нашата платформа.',
      commitmentText: 'CarMarket365 е посветена на обезбедување дека нашата платформа е достапна за луѓе со попреченост. Континуирано работиме на подобрување на корисничкото искуство за сите наши корисници.',
      visual: {
        title: 'Визуелни прилагодувања',
        features: [
          'Висок контраст и читливи фонтови',
          'Поддршка за зголемување на текстот',
          'Алтернативен текст за сите слики',
          'Јасна визуелна хиерархија'
        ]
      },
      motor: {
        title: 'Моторички прилагодувања',
        features: [
          'Навигација само со тастатура',
          'Големи области за кликање',
          'Поддршка за гласовни команди',
          'Прилагодливи контроли'
        ]
      },
      audio: {
        title: 'Аудио прилагодувања',
        features: [
          'Визуелни индикатори за звуци',
          'Титлови за видео содржина',
          'Текстуални алтернативи за аудио',
          'Прилагодлива јачина на звук'
        ]
      },
      cognitive: {
        title: 'Когнитивни прилагодувања',
        features: [
          'Едноставна и јасна навигација',
          'Конзистентен дизајн',
          'Помошни водичи и совети',
          'Можност за паузирање анимации'
        ]
      },
      standards: {
        title: 'Стандарди и упатства',
        description: 'Се придржуваме на меѓународни стандарди за пристапност.',
        wcagGuidelines: 'WCAG 2.1 насоки',
        wcagDescription: 'Се трудиме да се придржуваме на WCAG 2.1 ниво AA стандардите за веб пристапност.',
        platformCompatibility: 'Компатибилност на платформата',
        platformCompatibilityDescription: 'Нашата платформа е тестирана со различни асистивни технологии и прелистувачи.'
      },
      feedback: {
        title: 'Потребна ви е помош со пристапноста?',
        message: 'Ако се соочувате со пречки при користењето на нашата платформа или имате предлози за подобрување, ве молиме контактирајте не.',
        returnToPlatform: 'Назад на платформата',
        contactTeam: 'Контактирај тим за пристапност'
      }
    },
  ...
  safetyTips: {
    title: 'Безбедносни совети',
    subtitle: 'Важни совети за безбедно купување и продавање возила на нашата платформа.',
    backToHome: 'Назад на почетна',
    mainTitle: 'Ваша безбедност е наш приоритет',
    mainDescription: 'Следете ги овие важни совети за да обезбедите безбедна и успешна трансакција.',
    safetyOverview: 'Купувањето или продавањето возило може да биде возбудлива експериенза, но важно е да се преземат соодветни мерки за безбедност. Овие совети ќе ви помогнат да избегнете измами и да обезбедите безбедна трансакција.',
    
    meetingSafety: {
      title: 'Безбедност при средби',
      items: [
        'Секогаш се сретнувајте на јавно место со добро осветление',
        'Доведете пријател или член од семејството со вас',
        'Најавете некому за вашата локација и време на средбата',
        'Избегнувајте средби навечер или на изолирани места',
        'Довербавајте се на вашиот инстинкт - ако нешто не изгледа во ред, заминете'
      ]
    },
    ...
    paymentSecurity: {
      ...
      items: [
        'Никогаш не праќајте пари унапред без да го видите возилото',
        'Избегнувајте плаќања преку Western Union или сични услуги',
        'Користете банковен чек или банкарски трансфер за поголеми суми',
        'Проверете дека средствата се достапни пред да ги предадете клучевите',
        'Бидете претпазливи со необично ниски цени - тие може да се знак за измама'
      ]
    },
    
    vehicleInspection: {
      title: 'Проверка на возилото',
      items: [
        'Секогаш инспектирајте го возилото лично пред купување',
        'Направете тест возење во различни услови',
        'Проверете ги сите документи и историја на возилото',
        'Побарајте професионална проверка за скапи возила',
        'Проверете дека VIN бројот се совпаѓа со документите'
      ]
    },
    ...
    redFlags: {
      ...
      items: [
        'Продавачот бара итно плаќање или одлука',
        'Цената е значително под пазарната вредност',
        'Продавачот не сака да се сретне лично',
        'Недостасуваат важни документи или тие изгледаат фалсификувани',
        'Продавачот не може да одговори на основни прашања за возилото'
      ]
    },
    
    documentation: {
      title: 'Важна документација',
      description: 'Обезбедете се дека имате ја целата потребна документација за безбедна трансакција.',
      forBuyers: 'За купувачи',
      forSellers: 'За продавачи',
      buyerItems: [
        'Лична карта или пасош',
        'Доказ за осигурување',
        'Финансирање или доказ за средства',
        'Контакт информации за проверка'
      ],
      sellerItems: [
        'Сопственичка листа на возилото',
        'Сервисна историја и записи',
        'Важна регистрација',
