...
export const sqTranslations: TranslationStrings = {
  ...
  forms: {
    validation: {
      ...
      mileageRequired: 'Kilometrat e përshkuara është i detyrueshëm',
      mileageNegative: 'Kilometrat e përshkuara nuk mund të jetë negativ',
  ...
  hero: {
    title: 'Gjeni makinën tuaj ideale',
    subtitle: 'Shfletoni mijëra automjete cilësore të përdorura',
  ...
  auth: {
    ...
    createNewPassword: 'Krijoni një fjalëkalim të ri',
    enterNewPassword: 'Vendosni fjalëkalimin tuaj të ri më poshtë.',
    passwordResetSuccess: 'Fjalëkalimi u rivendos me sukses',
    passwordResetSuccessMessage: 'Fjalëkalimi juaj u përditësua. Tani mund të kyçeni me fjalëkalimin e ri.',
    ...
    backToHome: 'Kthehu tek faqja kryesore',
    signInToAccount: 'Kyçu në llogarinë tënde',
    welcomeBack: 'Mirë se erdhët përsëri',
    enterCredentials: 'Vendos të dhënat për t\'u kyçur në llogarinë tënde',
    privatePersonDescription: 'Blej ose shit makinën tënde',
    dealerDescription: 'Shitës profesionist',
    pro: 'Pro',
    enterYourEmail: 'Vendos email-in tënd',
    enterYourPassword: 'Vendos fjalëkalimin tënd',
    signingIn: 'Duke u kyçur...',
    orContinueWith: 'Ose vazhdo me',
    google: 'Google',
    facebook: 'Facebook',
    createPrivateAccount: 'Krijo llogari private',
    registerAsDealer: 'Regjistrohu si tregtar',
    dealerBenefits: 'Përfitimet e tregtarit',
    professionalDashboard: '• Panel profesional për tregtarë',
    inventoryManagement: '• Menaxhim i avancuar i inventarit',
    customerTracking: '• Ndjekje e kërkesave të klientëve',
    enhancedVisibility: '• Dukshmëri e zgjeruar për shpalljet',
    analyticsInsights: '• Analitika dhe të dhëna',
    
    // UserSignUp page specific
    createYourAccount: 'Krijo llogarinë tënde',
    joinThousands: 'Bashkohu me mijëra pasionantë të automjeteve',
    privateAccount: 'Llogari private',
    buyAndSellCars: 'Blej dhe shit makina, ruaj të preferuarat dhe menaxho shpalljet e tua',
    fullName: 'Emri i plotë',
    enterFullName: 'Shkruaj emrin tënd të plotë',
    emailAddress: 'Adresa e email-it',
    createStrongPassword: 'Krijo një fjalëkalim të fortë',
    confirmYourPassword: 'Konfirmo fjalëkalimin tënd',
    mustBeCharacters: 'Duhet të ketë të paktën 8 karaktere',
    agreeToTerms: 'Pranoj',
    termsOfService: 'Kushtet e shërbimit',
    and: 'dhe',
    privacyPolicy: 'Politikën e privatësisë',
    creatingAccount: 'Duke krijuar llogarinë…',
    wantSellAsDealer: 'Dëshiron të shesësh si tregtar?',
    createDealerAccount: 'Krijo llogari tregtari',
    joinCommunityText: 'Duke krijuar llogari, bashkohesh me komunitetin tonë dhe pranon rregullat e platformës.',

    // Error messages for signup
    pleaseAgreeTerms: 'Ju lutem pranoni kushtet',
    ...
    dealerRegistration: 'Regjistrimi i tregtarit',
    joinCarMarketDealer: 'Bashkohu me CarMarket365 si tregtar profesionist',
    businessInformation: 'Informacionet e biznesit',
    tellUsAboutBusiness: 'Na tregoni për biznesin tuaj',
    businessName: 'Emri i biznesit',
    businessNamePlaceholder: 'Emri i biznesit tuaj Sh.p.k.',
    businessType: 'Lloji i biznesit',
    selectBusinessType: 'Zgjidhni llojin e biznesit',
    carDealership: 'Sallon automjetesh',
    usedCarLot: 'Shitje makinash të përdorura',
    autoTrader: 'Tregtar automjetesh',
    carBroker: 'Ndërmjetës automjetesh',
    ...
    businessDescriptionPlaceholder: 'Përshkruani biznesin tuaj, specializimet dhe shërbimet…',
    contactPerson: 'Personi i kontaktit',
    primaryContactInfo: 'Informacioni kryesor i kontaktit për biznesin tuaj',
    position: 'Pozicioni',
    positionPlaceholder: 'p.sh. Pronar, Menaxher shitjesh',
    businessEmail: 'Email-i i biznesit',
    businessEmailPlaceholder: 'biznesi@shembull.com',
    businessAddress: 'Adresa e biznesit',
    dealershipLocation: 'Vendndodhja fizike e biznesit tuaj',
    streetAddress: 'Adresa e rrugës',
    streetAddressPlaceholder: 'Rr. e Biznesit 123',
    city: 'Qyteti',
    cityPlaceholder: 'Shkup',
    stateRegion: 'Shteti / Rajoni',
    stateRegionPlaceholder: 'Rajoni',
    ...
    createSecureDealerAccount: 'Krijoni llogarinë tuaj të sigurt të tregtarit',
    termsAndAgreements: 'Kushtet dhe marrëveshjet',
    acceptTermsConditions: 'Pranoj Kushtet e përgjithshme',
    agreeToTermsAndDealer: 'Ju pranoni Kushtet e shërbimit dhe Marrëveshjen e tregtarit tonë.',
    acceptPrivacyPolicy: 'Pranoj Politikën e privatësisë',
    understandDataCollection: 'Ju e kuptoni se si i mbledhim dhe përdorim të dhënat tuaja.',
    receiveMarketingCommunications: 'Dëshiroj të marr komunikime marketingu',
    getUpdatesFeatures: 'Merr përditësime rreth veçorive të reja dhe mundësive biznesore.',
    alreadyHaveAccountSignIn: 'Keni tashmë llogari? Kyçu',
    ...
    vatNumberRequired: 'Numri i TVSH-së është i detyrueshëm',
    firstNameRequired: 'Emri është i detyrueshëm',
    lastNameRequired: 'Mbiemri është i detyrueshëm',
    emailRequired: 'Email-i është i detyrueshëm',
    phoneRequired: 'Numri i telefonit është i detyrueshëm',
    streetRequired: 'Adresa e rrugës është e detyrueshme',
    cityRequired: 'Qyteti është i detyrueshëm',
    postalCodeRequired: 'Kodi postar është i detyrueshëm',
  ...
  sell: {
    ...
    buttons: {
      ...
      startSelling: 'Shitni automjetin tuaj',
    },
    ...
    bodyTypes: {
      ...
      compact: 'Makinë e vogël',
      sportsCar: 'Makinë sportive',
      offRoad: 'SUV/Terren/Pikap',
      other: 'Tjetër',
    },
    ...
    modelLabel: 'Modeli',
    yearLabel: 'Viti',
    mileageLabel: 'Kilometrat',
    priceLabel: 'Çmimi',
    conditionLabel: 'Gjendja',
    fuelTypeLabel: 'Lloji i karburantit',
    transmissionLabel: 'Transmisioni',
    exteriorColorLabel: 'Ngjyra e jashtme',
    interiorColorLabel: 'Ngjyra e brendshme',
    descriptionLabel: 'Përshkrimi',
    locationLabel: 'Vendndodhja',
    phoneLabel: 'Telefoni',
    emailLabel: 'Email',
    contactInfoTitle: 'Informacionet e kontaktit',
    addPhotosTitle: 'Shto fotografi',
    existingPhotos: 'Fotografitë ekzistuese',
    success: 'Sukses',
  },
  ...
  dealer: {
    ...
    confirmDeleteListing: 'A jeni i sigurt se dëshironi ta fshini këtë shpallje?',
    businessHours: 'Orari i punës',
    information: 'Informacione',
    notFound: 'Tregtari nuk u gjet',
    vehicleInventory: 'Inventari i automjeteve',
  },
  ...
  browseCars: {
    ...
    sortOptions: {
      ...
      mileageLowToHigh: 'Kilometrat e përshkuara: nga i ulët te i lartë',
      mileageHighToLow: 'Kilometrat e përshkuara: nga i lartë te i ulët',
    ...
    results: {
      ...
      sellCta: 'Keni një automjet për shitje? Shtoni shpalljen tuaj falas.',
    },
    carCard: {
      viewDetails: 'Shiko detajet',
  ...
  advancedSearch: {
    ...
    staticVehicleData: {
      ...
      fuelTypes: [
        'Benzina', 'Nafta', 'Hibride', 'Elektrike', 'Hibride me prizë', 'CNG', 'LPG',
      ...
      paintworkTypes: [
        'Metalike', 'Perlë', 'Mate', 'Tjetër'
      ],
      interiorColors: [
        'E zezë', 'Bezhë', 'Gri', 'Kafe', 'Blu e errët', 'Krem', 'Redwood', 'Tjetër'
      ],
      upholsteryTypes: [
        'Stof', 'Lëkurë e plotë', 'Lëkurë e pjesshme', 'Alcantara', 'Tjetër'
      ],
      countries: [
        'Maqedonia', 'Shqipëria', 'Kosova', 'Serbia', 'Mali i Zi', 'Bosnja dhe Hercegovina',
        'Kroacia', 'Sllovenia', 'Bullgaria', 'Greqia', 'Gjermania', 'Austria', 'Italia', 'Tjetër'
      ],
      emissionClasses: [
        'Euro 6', 'Euro 5', 'Euro 4', 'Euro 3', 'Euro 2', 'Euro 1', 'Pa standard'
      ],
      emissionLabels: [
        'E gjelbër', 'E verdhë', 'Portokalli', 'E kuqe', 'Pa etiketë'
      ],
      guaranteeOptions: [
        'Garanci prodhues', 'Garanci e zgjeruar', 'Garanci dealeri',
        'Garanci palë e tretë', 'Pa garanci'
      ]
    },
  ...
  contact: {
    ...
    address: 'Adresa',
    title: 'Na kontaktoni',
    subtitle: 'Jemi këtu për t\'ju ndihmuar. Na kontaktoni për çdo pyetje ose kërkesë mbështetjeje.',
    backToHome: 'Kthehu tek faqja kryesore',
    mainTitle: 'Si mund t\'ju ndihmojmë?',
    mainDescription: 'Ekipi ynë i mbështetjes së klientit është këtu për t\'iu përgjigjur pyetjeve dhe për t\'ju dhënë ndihmë.',
    contactOverview: 'Qofshi duke kërkuar ndihmë për blerjen e një automjeti, keni pyetje për shitjen, ose dëshironi të mësoni më shumë për shërbimet tona — jemi të disponueshëm përmes disa kanaleve komunikimi.',
    phoneSupport: {
    ...
    officeLocation: {
      title: 'Vendndodhja e zyrës',
      address: {
        street: 'Rr. Maqedonia pn',
        city: 'Shkup 1000',
    ...
    urgentSupport: {
      title: 'Nevojitet ndihmë urgjente?',
      message: 'Për çështje kritike, telefononi ekipin tonë të mbështetjes.',
      callNow: 'Telefono tani',
      browseCars: 'Shfleto makinat',
    },
    hero: {
  ...
  privateDashboard: {
    ...
    delete: 'Fshi',
    // Express Sale Tab
    expressSaleListings: 'Shpalljet e shitjes ekspres',
    quickSaleRequests: 'Kërkesat për shitje të shpejtë të dërguara tek shitësit',
    newExpressSale: 'Shitje ekspres e re',
    ...
    // Avatar upload
    avatarBadType: 'Zgjidhni një imazh.',
    avatarTooLarge: 'Imazhi duhet të jetë nën 5MB.',
    avatarSaved: 'Fotoja e profilit u përditësua.',
    avatarFailed: 'Ngarkimi dështoi — provoni përsëri.',
    uploadingPhoto: 'Duke u ngarkuar…',

    // Confirm / error dialogs
    confirmDeleteListing: 'A jeni i sigurt se dëshironi ta fshini këtë shpallje?',
    deleteAccountConfirmation: 'A jeni i sigurt? Ky veprim nuk mund të kthehet.',
    deleteAccountError: 'Dështoi fshirja e llogarisë. Provoni përsëri.',
    exportDataError: 'Dështoi eksportimi i të dhënave. Provoni përsëri.',
    expressSaleComingSoon: 'Shitja ekspres vjen së shpejti.',
    ...
    // Empty states
    noListingsYet: 'Ende nuk keni shpallje.',
    noRecentSearches: 'Nuk ka kërkime të fundit.',
    noSavedCars: 'Nuk keni automjete të ruajtura.',
    startBrowsing: 'Filloni të shfletoni.',
    ...
    welcomeBackMessage: 'Mirë se erdhët përsëri, {name}!'
  },
  ...
  countryTest: {
    ...
    automaticCountryDetection: 'Zbulimi Automatike i Vendit',
  ...
  finalFixes: {
    ...
    expressSell: {
      ...
      // Fushat kryesore të formularit
      carDetails: 'Detajet e makinës',
      carDetailsDescription: 'Na tregoni për makinën tuaj që të krijojmë një shpallje tërheqëse',
      makeRequired: 'Marka *',
      selectMake: 'Zgjidhni markën',
      modelRequired: 'Modeli *',
      selectModel: 'Zgjidhni modelin',
  ...
  advancedFeatures: {
    ...
    advancedSearch: {
      ...
      fields: {
        ...
        priceMin: 'Çmimi Min.',
        priceMax: 'Çmimi Maks.',
        mileageMax: 'Kilometrat e përshkuara Maks.',
      },
      ...
      features: {
        ...
        automaticEmergencyBraking: 'Frenmi Automatike Emergjent',
