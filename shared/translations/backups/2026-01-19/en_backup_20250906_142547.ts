...
export const enTranslations: TranslationStrings = {
  ...
  auth: {
    ...
    receiveMarkdatangCommunications: 'Ya khotel by by accessingat makdatangov kommunikatsii',
  ...
  sell: {
    ...
    headers: {
      ...
      photosAndContactDescription: 'Dobavte photos i kontaktn data',
    },
    ...
    fields: {
      ...
      exteriorColor: 'Exterior Color',
      interiorColor: 'Interior Color',
      askingPrice: 'Zaprashivaem price',
    ...
    headers: {
      ...
      additionalDetailsDescription: 'Add more details about your {vehicleType}',
      photosAndContact: 'Photos and Contact Information',
      photosAndContactDescription: 'Dobavte photos i vashi kontaktn data',
  ...
  pages: {
    ...
    termsOfService: {
      ...
      termsDescription: 'Pozhaluysta, carefully review s data terms before ispolzovaniem our platform.',
      overviewText: 'Dann Usloviya of service govern ispolzovanie your platform CarMarket365 i definot rights i obligations all users. Poluch access k our platforme, vy agree comply with data terms.',
      ...
      userResponsibilitiesList: [
        ...
        'Zashchishchat uchetn data vashego accounta'
      ],
      ...
      serviceLimitationsList: [
        ...
        'Otsutstvie garantiy na kontent trdatakh lits'
      ],
      ...
      accountManagementList: [
        ...
        'Khranotnie data posle prekrashcheniya'
      ],
      ...
      questionsAboutTerms: 'Voprosy ob datakh termskh?',
      questionsText: 'Esli u vas est questions ob datakh termskh ili vam nuzhny razyasnotniya po kakim-libo polozheniyam, please, obratites k our yuridicheskoy komande po adresu legal@carmaket365.com',
    ...
    privacyPolicy: {
      ...
      overviewText: 'Dann policy privacyi obyasnyaet, kak my sobiraem, ispolzuem, raskryvaem i zashchishchaem vashu informatsiyu pri ispolzovanii our platform car market. My priverzheny podderzhaniyu vysochayshikh standartov zashchity privacyi i safetyi data.',
      dataSecurity: 'Bezopasnost data',
      dataSecurityList: [
        'Shifrovanie otraslev standarta',
        'Bezopasn beforeacha data',
        'Regulyarn audity safetyi',
        'Ogranichen kontrol accessa'
      ],
      transparency: 'Prozrachnost',
      transparencyList: [
        'Chetkie praktiki sbora data',
        'Otkrytost ob ispolzovanii data',
      ...
      userRightsList: [
        ...
        'Zaprosy na udalenie data',
        'Otkaz ot kommunikatsiy'
      ],
      dataMinimization: 'Minimization data',
      dataMinimizationList: [
        'Sbor tolko notobkhodim data',
        'Ispolzovanie po naznacheniyu',
        'Automatic istechenie data',
        'Regulyarn ochistka data'
      ],
      ...
      usageDataList: [
        ...
        'Istoriya search i viewing',
        'Information ob ustroystve i brauzere',
        'Dann about location (if permitted)'
      ],
      questionsAboutPrivacy: 'Voprosy o privacyi?',
      privacyQuestionsText: 'Esli u vas est questions ob etoy politike privacyi ili nashikh praktikakh obrabotki data, please, obratites k our komande po privacyi po adresu privacy@carmaket365.com',
      returnToPlatform: 'Vernutsya na platformu',
    ...
    faq: {
      ...
      subtitle: 'Naydite answers na rasprostranotnn questions o buying, selle, financingovanii i ispolzovanii CarMarket365.',
      ...
      buyingFaqs: [
        ...
        {
          question: 'Vse li listings verified?',
          answer: 'Da, vse listings na CarMarket365 verified. My provodim verifyku biograficheskikh data all dealers i private sellers, a also verify informatsiyu o vehiclesakh na tochnost before razmeshcheniem.'
        },
        {
          question: 'Mogu li ya schedule na test drive?',
          answer: 'Of course! You can schedule a test drive directly through stranitsu s details car. Contact the seller to arrange a suitable time and place for the test drive.'
        },
        {
          question: 'Chto me vzyat s soboy dlya viewing car?',
        ...
        {
          question: 'Kak uznat, spravedliva li price car?',
          answer: 'My provide estimates market value dlya all vehicles. You can also compare similar cars, check report ob history vehiclesa and use our price analysis tools.'
        }
      ],
      ...
      sellingngFaqs: [
        {
          ...
          answer: 'Use the "Sell Car" form to create listings. Vam ponadobyatsya detali vehiclesa, photos, information o sostoyanii i kontaktn data. The process takes about 10-15 minutes.'
        },
        {
          question: 'Est li plata za razmeshchenie listings?',
          answer: 'Bazov listings besplatny dlya private sellers. My predlagaem premium varianty obyavleniy s povyshennoy vidimostyu za notbolshuyu platu. U dealers razn struktury pricesoobrazovaniya.'
        },
        {
          question: 'Skolko vremeni trebuetsya dlya selling car?',
        ...
        {
          question: 'Kakie dokumenty me nuzhny dlya selling car?',
        ...
        },
        {
          ...
          answer: 'Ispolzuyte nash besplat instrument estimates vehicles, study similar listings, uchtite sostoyanie vashego car, probeg and any recent repairs or improvements.'
        }
      ],
      ...
      financingFaqs: [
        {
          ...
          answer: 'Da, my sotrudnichaem s notskolkimi kreditorami, to predlozhit konkurentn varianty financingovaniya. Vy can by accessingit previewn approvedie online za notskolko minut bez vliyaniya na vash kredit reyting.'
        },
        {
          question: 'Kakoy kredit reyting me nuzhen dlya avtokreditovaniya?',
        ...
        },
        {
          ...
          answer: 'Zapolnite nashu online-zvku, to get instant pre-approval, vyberite vashe vehicleso and complete the loan process. Ves protsess mozhno zavershit online ili po phone.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Mnogie iz nashikh partnotrov-dealers prinimayut cari v zachet. Poluchite opricesku obmena s helpyu nashego instrumenta estimates, zatem obsudite varianty s dealerom pri buying.'
        }
      ],
      ...
      safetyFaqs: [
        {
          ...
          answer: 'Meet in public places, bring someone with you, verify lichnost seller, tshchatelno osmatrivayte vehicleso and use secure payment methods. Never transfer money i not platite do osmotra car.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Proverte ikh profil na CarMarket365, prochtite otzyvy, podtverdite ikh kontaktnuyu informatsiyu i vstrettes lichno. Vse nashi dealers previewno verified i proshli verifyku biograficheskikh data.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Da, my provide kompleksn reporty ob history vehicles iz nadezhn istochnikov. Oni vklyuchayut istoriyu avariy, zapisi ob obsluzhivanii i informatsiyu o rightskh sobstvennotss.'
        }
      ],
      ...
      accountFaqs: [
        ...
        },
        {
          ...
          answer: 'Voydite v vash account i pereydite v "Settings accounta", gde vy can obnovit lichnuyu informatsiyu, kontaktn data i predpochteniya.'
        },
        {
          question: 'Mogu li ya save cari dlya viewing pozzhe?',
          answer: 'Da! Nazhmite znachok serdtsa na anyom obyavlenii car, to save ego v izbrann. Poluchite access k sokhranotedm carm v any time iz panotli upravleniya vashego accounta.'
        },
        {
  ...
  browseCars: {
    ...
    filters: {
      ...
      color: 'Color',
      drivetrain: 'Drive type',
      minPrice: 'Minimaln price',
      maxPrice: 'Maksimaln price',
      noMin: 'Bez min.',
      noMax: 'Bez maks.',
  ...
  advancedSearch: {
    ...
    // Staticheskie data carey dlya advancedn search
    staticVehicleData: {
      makes: [
  ...
  contact: {
    hero: {
      ...
      subtitle: 'Svyazhites s our komandoy. My zdes, to help vam find ideal car ili otvdatat na any questions.',
    },
    departments: {
    ...
    form: {
      ...
      subtitle: 'Zapolnite formu nizhe, i my otvdatam v techenie 24 chasov.',
      inquiryType: {
        label: 'Chem my mozhem help?',
        placeholder: 'Select Request Type',
        options: {
          buying: 'Pokupka car',
          sellingng: 'Prodazha car',
    ...
    success: {
      ...
      message: 'Spasibo, chto svyazalis s nami. My otvdatam v techenie 24 chasov.',
    },
    quickHelp: {
      title: 'Bystr help',
      subtitle: 'Ishchete notmedlenn answers? Proverte data resursy.',
      options: {
        buyingGuide: {
          title: 'Guide po buying',
          description: 'Uznayte, kak kupit car',
        },
        sellingngGuide: {
          title: 'Guide po selle',
          description: 'Sovety po selle vashego car',
        },
        faq: {
          title: 'FAQ',
  ...
  dealerProfilee: {
    ...
    visitWebsite: 'Posdatat veb-sayt',
    overview: 'Obzor',
    inventory: 'Inventar',
    reviews: 'Reviews',
    contact: 'Contact',
  ...
  privateDashboard: {
    ...
    quickSaleRequests: 'Zaprosy bystroy selling, otpravlenn dealeram',
    ...
    personalInformation: 'Lichn information',
    updateProfileeDetails: 'Obnovit data profilya',
    ...
    notifyNewCarsMatching: 'Poluchat uvedomleniya o nov carkh, sootvetstvuyushchikh vashim searchm',
    ...
    controlPrivacyPreferences: 'Kontroliruyte svoi nastroyki privacyi i obmena data',
    ...
    dataAnalytics: 'Analitika data',
    helpImproveService: 'Pomogite uluchshit nash servis s helpyu analitiki of use',
    accountManagement: 'Upravlenie accountom',
    manageAccountAndData: 'Upravlyayte svoim accountom i data',
    downloadMyData: 'Skachat moi data',
  ...
  savedCars: {
    title: 'Saved Cars',
    subtitle: 'Upravlyayte svoimi anyim vehiclesami i spiskom zhelaniy',
    ...
    startBrowsing: 'Nachnite prosmatrivat vehiclesa, to save izbrann',
    browseVehicles: 'Prosmotret vehiclesa',
    savedOn: 'Saved',
  ...
  sellVehicle: {
    ...
    subtitle: 'Sozdayte podrobn listing dlya vashego vehiclesa',
    stepIndicator: 'Shag {current} iz {total}',
    basicInfo: 'Basic Information',
    vehicleDetails: 'Detali vehiclesa',
    ...
    description: 'Description',
    descriptionPlaceholder: 'Opishite vashe vehicleso, ego istoriyu, sostoyanie...',
    ...
    requirementsList: [
      ...
      'Fotografii so all storon vehiclesa',
      'Fotografii interera',
    ...
    compdatative: 'Konkurentosposobn',
  ...
  indexPage: {
    ...
    stats: {
      ...
      arsExperience: 'Years Experience'
    },
    featuredListings: {
      ...
      steps: [
        {
          ...
          description: 'Prosmatrivayte nashu obshirnuyu bazu verifyenn vehicles'
        },
        {
    ...
    testimonials: {
      ...
      subtitle: 'Prochitayte realn otzyvy ot nashikh dovoln buyingrey'
    },
    newsletter: {
  ...
  dealerDashboard: {
    ...
    overview: {
      ...
      performance: {
        ...
        description: 'Kolichestvo prodata carey po mesyatsam v etom year',
        monthlyData: {
          january: 'Yanvar',
          december: 'Dekabr',
          november: 'November',
    ...
    analytics: {
      ...
      performanceMetrics: {
        ...
        metrics: {
          averageTimeToSell: 'Srednote time selling',
    ...
    reports: {
      ...
      platformStatistics: {
        ...
        metrics: {
          ...
          averageListingPrice: 'Sredny price listings',
        },
      },
  ...
  countryTest: {
    ...
    crossCountryDescription: 'Esli kto-to pexperienceetsya by accessingit access k obyavleniyu car iz otheroy strany (through directlyy URL), on by accessingit soobshchenie ob oshibke, chto listing notaccessno v ikh regionot.',
  ...
  about: {
    ...
    content: {
      ...
      missionContent: 'To revolutionize the car buying and sellingng experience by providing a transparent, reliable, and user-friendly platform that connects people with their ideal vehicle.',
  ...
  carReviews: {
    title: 'Obzory carey',
    subtitle: 'Ekspertn reviews i otzyvy users, kotor pomogut vam prinimat obosnovann resheniya pri buying sleduyushchego car.',
    backToHome: 'Nazad na glavnuyu',
    
    // Main content
    overviewTitle: 'Obzory i reytingi carey',
    overviewDescription: 'Kompleksn reviews, kotor pomogut vam prinimat obosnovann resheniya pri buying vehicles.',
    overviewText: 'Nash razdel obzorov carey predostavlyaet detal analiz ot carn ekspertov i real opyt vladeltsev, to help vam ponyat vse aspekty rassmatrivaem vehicles.',
    ...
    expertReviews: {
      ...
      features: [
        ...
        'Sravniteln testirovanie vehicles'
      ]
    },
    ownotrReviews: {
    ...
    maketInsights: {
      ...
      features: [
        ...
        'Sezonn rukovodstva po buying'
      ]
    },
    
    // Categories
    categoriesTitle: 'Categories obzorov',
    categoriesDescription: 'Nashi reviews okhvatyvayut vse aspekty vladeniya i proizvoditelnotss vehicles.',
    performance: {
    ...
    comingSoonText: 'V nastoyashchee time my stroim nashu kompleksnuyu bazu data obzorov. Ekspertn reviews i otzyvy vladeltsev skoro budut accessny, to help napravit vashi resheniya o buying carey.',
  ...
  safetyTips: {
    title: 'Sovety po safetyi',
    subtitle: 'Basic safety recommendations for buying, sellingng and servicing your car.',
    backToHome: 'Nazad na glavnuyu',
    
    // Main content
    mainTitle: 'Rekomendatsii po safetyi carey',
    mainDescription: 'Kompleksn tips po safetyi dlya secureoy buyi i selling carey.',
    safetyOverview: 'Whether you\'re buying your first car or sellingng your current onot, following appropriate safety recommendations protects you from fraud, ensures fair deals, and helps maintain your personal safety throughout the process.',
    ...
    paymentSecurity: {
      ...
      items: [
        'Nikogda not otpravlyayte dengi ili depozity do osmotra car',
    ...
    vehicleInspection: {
      ...
      items: [
        ...
        'Proverte vse dokumenty i istoriyu car',
    ...
    redFlags: {
      ...
      items: [
        'Prodavets otkazyvaetsya vstrdatatsya lichno',
        'Trebovanie oplaty do osmotra car',
    ...
    documentation: {
      ...
      description: 'Vazhn dokumenty dlya verifyki i by accessingeniya pri sdelkakh s carmi.',
      forBurs: 'Dlya buyingrey',
      burItems: [
        'Svidetelstvo o registeratsii car',
        'Deystvuyushchie dokumenty seller',
  ...
  expressSell: {
    ...
    subtitle: 'Razmestite vash car za minuty s helpyu nashego ekspress-protsessa selling',
    backToHome: 'Nazad na glavnuyu',
    step: 'Shag',
    of: 'iz',
    ...
    enterDescription: 'Vvedite opisanie',
    descriptionPlaceholder: 'Opishite osobennotss, sostoyanie i istoriyu vashego car...',
    photosAndContact: 'Foto i kontakty',
    photosAndContactDescription: 'Dobavte photos i vashu kontaktnuyu informatsiyu',
    carPhotos: 'Fotografii car',
    carPhotosRequired: 'Fotografii car *',
    uploadPhotos: 'Zagruzit photos',
  ...
  financing: {
    ...
    subtitle: 'Naydite luchshie varianty financingovaniya dlya buyi vashego sleduyushchego car.',
    ...
    staticContent: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Da, vse professionaln prodavtsy verified our komandoy. Chastn prodavtsy also prokhodyat bazovyy protsess verifikatsii. Ishchite znak verifikatsii v profilyakh sellers dlya polnoy prozrachnotss.'
        },
        {
          id: 'buy-3',
          category: 'buying',
          question: 'Mogu li ya protestirovat car before buyoy?',
          answer: 'Konotchno! Bolshinstvo sellers razreshayut test drivey. Svyazhites s seller, to naznachit vstrechu dlya test drivea. Vsegda berite deystvuyushchie voditelskie rights i ubedites, chto u car est deystvuyushch strakhovka.'
        },
        {
          id: 'buy-4',
          category: 'buying',
          question: 'Chto ya dolzhen check before buyoy car?',
          answer: 'Proverte: istoriyu car, pravov dokumenty, fizichesk sostoyanie, osnovn sistemy (dvigatel, tormoza, transmissiya) i sovershite test drive. My also rekomenduem osmotr u doverenn mekhanika.'
        },
        {
          id: 'buy-5',
          category: 'buying',
          question: 'Predostavlyaet li CarMarket365 garantii na cari?',
          answer: 'CarMarket365 - eto platforma, kotor sdinyaet buyingrey s sellermi. Garantii predostavlyayutsya individualn sellermi. Bolshinstvo professionaln sellers predlagayut ogranichenn garantii. Proverte detali garantii s seller before buyoy.'
        },
        {
          id: 'sell-1',
          category: 'sellingng',
          question: 'Skolko stoit prodat car na CarMarket365?',
          answer: 'Bazov razmeshchenie besplatno dlya private sellers. My also predlagaem premium optsii s dopolniteln funktsiyami, takimi kak luchsh ekspozitsiya i professionaln fotografiya. U professionaln sellers est mesyachn plany s advancedn funktsiyami.'
        },
        {
          id: 'sell-2',
          category: 'sellingng',
          question: 'Skolko vremeni zanimaet sella car?',
          answer: 'Vremya selling zavisit ot notskolkikh faktorov: pricesy, sostoyaniya car, sprosa na rynke i kachestva listings. V srednotm cari prodayutsya v techenie 2-8 notdel. Obyavleniya s konkurentn pricemi i kachestvenn fotografiyami prodayutsya bystree.'
        },
        {
          id: 'sell-3',
          category: 'sellingng',
          question: 'Kak ya mogu uvelichit shansy selling mgo car?',
          answer: 'Ispolzuyte professionaln photos, pishite detaln opisaniya, ustanavlivayte konkurentn pricesy, budte chestny o sostoyanii car i bystro otvechayte na questions. Takzhe rassmotrite nash servis professionalnoy photos.'
        },
        {
          id: 'sell-4',
          category: 'sellingng',
        ...
        },
        {
          ...
          answer: 'Da, vy can change pricesu v any time iz vashey panotli upravleniya. My rekomenduem monitorit rynok i korrektirovat pricesy po notobkhodimosti dlya maksimizatsii interesa buyingrey.'
        },
        {
          id: 'financing-1',
          category: 'financing',
        ...
        },
        {
          ...
          answer: 'Propricestn stavki nachinayutsya ot 3.9% godov dlya kvalifitsirovann zviteley. Aktualn stavka zavisit ot vashego kreditn reytinga, dokhodov, sroka kredita i tipa car. Ispolzuyte nash kredit kalkulyator dlya previewnoy estimates.'
        },
        {
          id: 'safety-1',
          category: 'safety',
          question: 'Kak byt v safetyi pri buying u private seller?',
          answer: 'Vsegda vstrechaytes v obshchestvenn mestakh, bring someone with you, osmatrivayte car pri dnotvnom svete, verify lichnost seller i not nosite bolshie summy nalichn. Ispolzuyte nashi rekomenduem sposoby oplaty dlya secure sdelok.'
        },
        {
          id: 'safety-2',
          category: 'safety',
        ...
        },
        {
          ...
          answer: 'Nazhmite "Zaregisterirovatsya" vverkhu stranitsy. Vy can choose mezhdu privateym accountom (dlya buyingrey i private sellers) ili professionalnym accountom (dlya sellers i dealers). Protsess besplat i zanimaet vsego notskolko minut.'
        },
        {
          id: 'account-2',
          category: 'account',
          question: 'Mogu li ya change tip mgo accounta pozzhe?',
          answer: 'Da, vy can v any time obnovitsya s private do professionaln accounta. Svyazhites s our podderzhkoy clientov dlya helpi s perenosom. Obratite vnimanie, chto notkotor funktsii mogut byt not perenosimy.'
        },
        {
          id: 'account-3',
          category: 'account',
  ...
  registeredDealers: {
    ...
    descriptions: {
      ...
      cityMotorsDescription: 'Semey avtosalon, obsluzhivayushchiy Myunkhen i okrestnotss. Izvesten otlichnym obsluzhivaniem clientov i spravedliv pricemi.',
      ecoWheelsDescription: 'Vedushchiy spetsialist po elektricheskim i gibridnym carm v Gamburge. Priverzhen resheniyam ustoychiv vehiclea.',
      rheinAutoDescription: 'Spetsialisty po sportivnym carm v Reynskoy oblasti. Obshirn kollektsiya vysokoproizvoditeln carey.',
      stuttgartLuxuryDescription: 'Avtorizovan dealer Mercedes-Benz i Porsche v Shtutgarte. Dom luchshey notmetskoy inzhenotrii.',
      nordFahrzeugeDescription: 'Spetsialist po korporativnym carm, obsluzhivayushchiy delovoy rayon Frankfurta. Ekspert po resheniyam avtoparkov i lizingu.',
    },
  },
  ...
  hardcodedFixes: {
    ...
    // AdminDashboard - znachki statusa i mok-data
    adminDashboard: {
      statusBadges: {
    ...
    financing: {
      features: {
        ...
        expertSupport: {
          ...
          description: 'Predata spetsialisty po kreditam',
        },
      },
      form: {
    ...
    contact: {
      ...
      subtitle: 'Svyazhites s our komandoy dlya support, voprosov ili helpi v buying ili selle car.',
      backToHome: 'Vernutsya na glavnuyu',
      ...
      contactOverview: 'If you have questions about buying a car, need help sellingng your vehicle, or require technical support, our team is ready to help you. Choose the most convenient way to contact us.',
      ...
      success: {
        ...
        message: 'Spasibo za obrashchenie k nam. My by accessingili vashe soobshchenie i otvdatam v techenie 24 chasov.'
      },
      ...
      quickHelp: {
        ...
        options: {
          buyingGuide: {
            title: 'Guide po buying car',
            description: 'Uznayte o nashem protsesse buyi carey'
          },
          sellingngGuide: {
            title: 'Guide po selle car', 
            description: 'Poluchite help v selle vashego vehiclesa'
          },
          faq: {
            title: 'Chasto asked questions',
    ...
    registeredDealers: {
      ...
      descriptions: {
        ...
        cityMotorsDescription: 'Semey dealerskiy pricestr, obsluzhivayushchiy Myunkhen i prilegayushchie rayony. Izvesten otlichnym obsluzhivaniem clientov i chestn pricemi.',
    ...
    safetyTips: {
      mainTitle: 'Bezopasnost buyi i selling carey',
      mainDescription: 'Basic safety recommendations for protection during car transactions.',
      safetyOverview: 'Your safety - nash glav prioritet. Sleduyte datam rekomendationm dlya obespecheniya secure i uspeshn experience buyi i selling carey na our platforme.',
      medatangSafety: {
        title: 'Bezopasnost vstrech',
        items: [
      ...
      documentation: {
        ...
        forSellers: 'Dlya sellers',
        burItems: [
          'Nazvanie car ili registeration',
          'Zapisi o tekhnicheskom obsluzhivanii',
          'Vehicle history report',
          'Bill of sale with all details'
        ],
        sellerItems: [
          'Proverka valid ID buyingrya',
          'Podtverzhdenie strakhovki (pri test drivee)',
          'Pismenn soglashenie o buying',
  ...
  carDetail: {
    ...
    vehicleTitle: 'Zagolovok car',
    locationLabel: 'Location',
    priceLabel: 'Price',
    originalPrice: 'Pervonachaln price',
    ...
    mockData: {
      ...
      wellMaintainotd: 'Khorosho obsluzhivaem vehicleso v otlichnom sostoyanii.',
      ...
      description: 'Khorosho obsluzhivaem vehicleso v otlichnom sostoyanii.',
      historyEvents: [
  ...
  advancedFeatures: {
    ...
    advancedSearch: {
      ...
      sections: {
        ...
        featuresOptions: 'Features and Options',
      },
