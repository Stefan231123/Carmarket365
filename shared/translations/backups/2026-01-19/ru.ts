...
export const ruTranslations: TranslationStrings = {
  ...
  // Features Section
  features: {
    title: 'Почему выбирают CarFinder?',
    subtitle: 'Мы делаем покупку автомобиля простой, безопасной и прозрачной благодаря нашей комплексной платформе',
    items: {
      verifiedListings: {
        title: 'Проверенные объявления',
        description: 'Все автомобили проверяются и верифицируются нашей командой экспертов для обеспечения качества и подлинности.',
      },
      advancedSearch: {
        title: 'Расширенный поиск',
        description: 'Найдите именно то, что вы ищете, с помощью наших мощных фильтров поиска и умных рекомендаций.',
      },
      bestPrices: {
        title: 'Лучшие цены',
        description: 'Конкурентные цены без скрытых комиссий. Получите лучшее соотношение цены и качества каждый раз.',
      },
      freeDelivery: {
        title: 'Бесплатная доставка',
        description: 'Доставим ваш автомобиль к порогу дома в радиусе 80 км. Безопасная и надежная транспортировка.',
      },
      quickProcess: {
        title: 'Быстрый процесс',
        description: 'Завершите покупку за несколько минут благодаря нашему упрощенному процессу покупки и цифровому документообороту.',
      },
      expertSupport: {
        title: 'Экспертная поддержка',
        description: 'Наша преданная команда готова помочь вам на каждом этапе от поиска до покупки.',
      },
    },
  },
  ...
  auth: {
    ...
    resetPasswordDescription: 'Введите адрес электронной почты, и мы отправим вам ссылку для сброса пароля.',
    sendResetLink: 'Отправить ссылку для сброса',
    checkYourEmail: 'Проверьте вашу почту',
    resetLinkSent: 'Мы отправили ссылку для сброса пароля на',
    nextSteps: 'Следующие шаги',
    checkEmailInbox: 'Проверьте папку входящих (и папку спам)',
    clickResetLink: 'Нажмите на ссылку сброса в письме',
    createNewPassword: 'Создайте новый пароль',
    tryAnotherEmail: 'Попробуйте другую почту',
    
    // Access denied section
    accessDenied: {
      title: 'Доступ запрещен',
      signInRequired: 'Пожалуйста, войдите в систему для доступа к этой странице.',
      insufficientPermissions: 'У вас недостаточно прав для доступа к этой странице.',
    ...
    // Registration failed
    registerationFailed: 'Регистрация не удалась',
    
    // Social login
    socialLogin: {
      signingIn: 'Вход в систему...',
      google: {
        description: 'Используйте ваш аккаунт Google для быстрого входа или создания нового аккаунта.',
      },
      facebook: {
        description: 'Подключитесь через Facebook для доступа к вашему аккаунту CarMarket365.',
      },
    },
  },
  ...
  business: {
    qualityUsedCars: 'Качественные подержанные автомобили от',
    registeredDealers: 'зарегистрированных дилеров',
  },
  ...
  errors: {
    ...
    errorBoundary: {
      message: 'Что-то пошло не так. Пожалуйста, обновите страницу.',
  ...
  admin: {
    ...
    panotl: 'Панель администратора',
  },

  dealer: {
    notFound: 'Дилер не найден',
    information: 'Информация о дилере',
    businessHours: 'Рабочие часы',
    vehicleInventory: 'Инвентарь автомобилей',
  ...
  browseCars: {
    ...
    sortOptions: {
      ...
      arNewestFirst: 'Год: сначала новые',
      arOldestFirst: 'Год: сначала старые',
  ...
  advancedSearch: {
    ...
    fuelType: 'Тип топлива',
    anyMake: 'Любая марка',
    anyBodyType: 'Любой тип кузова',
    anyFuelType: 'Любой тип топлива',
    additionalProperties: 'Дополнительные характеристики',
    searchCars: 'Поиск Автомобилей',
    ...
    distances: {
      25: 'В радиусе 25 км',
      50: 'В радиусе 50 км',
      100: 'В радиусе 100 км',
      200: 'В радиусе 200 км',
      250: 'В радиусе 250 км',
      500: 'В радиусе 500 км',
    ...
    description: 'Используйте наши комплексные поисковые фильтры, чтобы найти именно тот автомобиль, который вы ищете',
    searchingRealTime: 'Поиск в реальном времени...',
    searchControls: 'Управление поиском',
    refineSearchCriteria: 'Уточните критерии поиска',
    searching: 'Поиск...',
    clearAllFilters: 'Очистить все фильтры',
    activeFilters: 'Активные фильтры',
    realTimeSearch: 'Результаты поиска в реальном времени',
    carsFound: 'Найдено автомобилей',
    hasMore: 'Доступно больше',
    allShown: 'Все показаны',
  ...
  about: {
    content: {
      journotyTitle: 'Наш путь',
      journotyDescription: 'Ключевые вехи, которые формировали нашу компанию на протяжении лет',
    },
    stats: {
  ...
  financing: {
    ...
    desiredLoanAmount: 'Желаемая сумма кредита',
    enterLoanAmount: 'Введите сумму кредита',
    enterAnnualIncome: 'Введите годовой доход',
    enterMonthlyExpenses: 'Введите ежемесячные расходы',
    selectRange: 'Выберите диапазон',
  ...
  carDetail: {
    ...
    errors: {
      ...
      dsntExist: 'Автомобиль, который вы ищете, не существует или был удален.',
  ...
  finalFixes: {
    ...
    expressSell: {
      PhoneNumberRequired: 'Номер телефона *',
      PhonePlaceholder: 'Ваш номер телефона',
      listMyCyear: 'Разместить мой автомобиль',
    },
    uiDemo: {
      enhancedFormComponotnts: 'Улучшенные компоненты форм',
      formComponotntsWithValidation: 'Компоненты форм с улучшенной валидацией и доступностью',
      componotnts: 'Компоненты',
    },
  },
  ...
  contact: {
    ...
    mainDescription: 'Несколько способов связаться с нашей службой поддержки для получения помощи.',
    title: 'Связаться с нами',
    subtitle: 'Свяжитесь с нашей командой для получения поддержки, ответов на вопросы или помощи с покупкой или продажей автомобилей.',
    contactOverview: 'Если у вас есть вопросы о покупке автомобиля, нужна помощь с продажей вашего транспорта или требуется техническая поддержка, наша команда готова помочь вам. Выберите наиболее удобный способ связи с нами.',
    ...
    urgentSupport: {
      title: 'Нужна немедленная помощь?',
      message: 'Для срочных вопросов или немедленной помощи звоните на нашу линию поддержки или просматривайте доступные автомобили.',
      callNow: 'Позвонить сейчас',
      browseCars: 'Просмотреть автомобили',
    },
  },

  // Error Boundary and errors
  errors: {
    errorBoundary: {
      tryAgain: 'Попробовать снова',
    },
  ...
  hardcodedFixes: {
    accessibility: {
      wcagGuidelinots: 'Рекомендации WCAG',
    },
    dealers: {
      viewProfilee: 'Посмотреть профиль',
    },
    registeredDealers: {
      ars: 'лет',
      viewProfilee: 'Посмотреть профиль',
      specialties: {
        businotssCars: 'Бизнес автомобили',
      },
    },
  },
  ...
  indexPage: {
    cta: {
      bur: {
        title: 'Готовы купить?',
        subtitle: 'Найдите свой идеальный автомобиль сегодня',
        button: 'Просмотреть автомобили',
      },
    },
  },
  ...
  legal: {
    ...
    imprint: {
      companyDetails: {
        registerationNumber: 'Регистрационный номер',
        registerationNumberValue: 'HRB 123456 B',
      },
      contactInfo: {
        PhoneValue: '+49 (0) 30 12345678',
        businotssHours: 'Рабочие часы',
        businotssHoursValue: 'Пн-Пт: 9:00 - 18:00 CET',
      },
    },
  },
  ...
  modals: {
    ...
    share: {
      title: 'Поделиться этим автомобилем',
      description: 'Поделитесь этим автомобилем с друзьями и семьей',
      facebook: 'Facebook',
      twitter: 'Twitter',
  ...
  dealerSupport: {
    PhoneHours: 'Телефонная поддержка доступна в рабочие часы',
    businotssHours: 'Рабочие часы',
    supportChannotls: 'Каналы поддержки',
    supportChannotlsDesc: 'Несколько способов получить помощь, когда она вам нужна',
  },
  ...
  // Redirect
  redirect: {
    showDetails: 'Как мы это определили?',
  },
